<div class="toolbar-app">
    ...
    <ul>
        <li>
            <a id="chatzalo" target="_blank" href="<?= (!empty($qrzalo['idzalo'])) ? $func->checkLinkZalo($qrzalo['idzalo'], $qrzalo['zalo'], $deviceType, $isIOS) : 'https://zalo.me/' . $func->parsePhone($qrzalo['zalo']) ?>" title="title">
        ...
        <li>
            <a id="chatfb" href="https://m.me/<?= $func->getNameFacebook($optsetting['fanpage']) ?>" title="title">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="256" height="256">
