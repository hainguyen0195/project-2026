<div class="comment-page">
    ...
    <div class="comment-statistic mb-4">
        <div class="card">
            <div class="card-header text-uppercase"><strong><?= danhgiasanpham ?></strong></div>
            <div class="card-body">
                <div class="row align-items-center py-3">
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="text-center">
                            <div class="comment-title"><strong><?= danhgiatrungbinh ?></strong></div>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        <div class="text-center">
                            <p class="mb-2"><?= chiasenhanxetvesanpham ?></p>
                            <button type="button" class="relative btn btn-sm btn-warning btn-write-comment py-2 px-3"><strong><?= vietnhanxetcuaban ?></strong></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="comment-write mb-4" id="comment-write">
        <div class="card">
            <div class="card-header text-uppercase"><strong><?= guinhanxetcuaban ?></strong></div>
            <div class="card-body">
                <form id="form-comment" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="form-group mb-2">
                                <label class="mb-2">1. <?= danhgiavesanphamnay ?>:</label>
                            ...
                            <div class="form-group mb-2">
                                <label for="review-title" class="mb-2">2. <?= tieudecuanhanxet ?>:</label>
                                <input type="text" class="form-control text-sm" name="dataReview[title]" id="review-title" placeholder="<?= nhaptieudenhanxet ?> *">
                            </div>
                            <div class="form-group mb-2">
                                <label for="review-content" class="mb-2">3. <?= vietnhanxetcuabanvaobenduoi ?>:</label>
                                <textarea class="form-control text-sm" name="dataReview[content]" id="review-content" placeholder="<?= nhanxetcuabanvesanphamnay ?> *" rows="11"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label class="mb-2">4. <?= thongtinlienhe ?>:</label>
                                <div class="row row-10">
                                    <div class="col-4 mg-col-10">
                                        <input type="text" class="form-control text-sm" name="dataReview[fullname]" id="review-fullname" placeholder="<?= nhaphotenlienhe ?> *">
                                    </div>
                                    <div class="col-4 mg-col-10">
                                        <input type="text" class="form-control text-sm" name="dataReview[phone]" id="review-phone" placeholder="<?= nhapsodienthoailienhe ?> *">
                                    </div>
                                    <div class="col-4 mg-col-10">
                                        <input type="text" class="form-control text-sm" name="dataReview[email]" id="review-email" placeholder="<?= nhapemaillienhe ?> *">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-group mb-2 review-preview">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="comment-count mb-2"><strong>(<?= $comment->total ?> <?=nhanxet?>)</strong></div>
                            ...
                            <?php /* if ($comment->hasMedia) { ?>
                                <hr>
                                <div class="form-group mb-2">
                                    <label class="mb-2"><strong><?= hinhanh ?>: (<?= toida3hinh ?>)</strong></label>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="review-poster-video-avatar avatar mb-3">
                                        ...
                                        <div class="avatar-dimension">
                                            <p class="mb-0"><?=hinhanhdaidien?></p>
                                            <p class="mb-0"><?=dinhdang?>: <strong><?= $config['website']['video']['poster']['extension'] ?></strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="video-config">
                                        <span class="d-inline-block me-2"><?=dinhdang?>: <strong><?= implode(" | ", $config['website']['video']['extension']) ?></strong></span>
                    ...
                    <button type="submit" class="btn btn-sm btn-warning text-capitalize py-2 px-3"><strong><?= guinhanxet ?></strong></button>
    ...
    <?php if (!empty($comment->lists)) { ?>
        <div class="comment-lists">
            <div class="card">
                <div class="card-header text-uppercase"><strong><?= cacbinhluankhac ?></strong></div>
